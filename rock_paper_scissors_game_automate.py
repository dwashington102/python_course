...
def start_game():
    ...
    while stop_game != 'n':
        ...
        #stop_game = input('Do you want to play again(y/n: ').lower()
...
# get_two_player function takes user input for player_1  and player_2 and passes to play_game_9 ()
...
# play_game() accepts player_1 variable, sets total wins for each user to 0,
...
def final_results(player_1, player_2, total_p1_wins, total_p2_wins):
    print()
    print('Player-1 {} '.format(player_1), 'Total Wins: ', total_p1_wins, sep='')
    print('Player-2 {} '.format(player_2), 'Total Wins: ', total_p2_wins, sep='')


# play_game_2p accepts player_1 and player_2 ariables sets total wins for each user to 0,
# creates options_list[], sets play_again sentinel value, and plays rock-paper-scissors
...
def play_game_9(player_1, player2):
    total_p1_wins = 0
    total_p2_wins = 0
    options_list = ['rock', 'paper', 'scissors']
    play_again = 'y'
